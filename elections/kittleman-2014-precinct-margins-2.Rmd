...
victory. (The map is based on precinct boundaries made available by
the Howard County GIS division on the [data.howardcountymd.gov][]
site.)
...
Recall that `readOGR()` function returns a special type of data
...
Now comes the fun part: actually mapping the data.  First I convert to
...
percentage of votes in each precinct. This graph is produced almost
